...
import { ContentfullLayout, Layout } from "./types/layout/layout";
...
import { RegionLayoutRelation } from "./types/relations/layout-document-relation";
import { generateRelations } from "./services/relations/layout-document-relation";
      ...
      children: [
        {
          ...
          loader: async ({}) => {
            ...
            return [refs, await fetchKeywords()];
          },
        },
        {
          path: "documents/:id",
          ...
          loader: async ({ params }) => {
            ...
            return [directory, document, layout, await fetchKeywords()];
          },
        },
      ],
    },
